#importing the required libraries  **** WOrking Code*****
import torch
...
original_image=image_loader('../../data/images/predict/test.jpg')
style_image=image_loader('../../data/images/style/TajMahal.jpg')
...
for e in range (epoch):
    ...
    print (f'Epoch [{e+1}/{epoch}], Loss: {total_loss.item():.4f}')
